...
CREATE TABLE IF NOT EXISTS tenants (
  ...
  default_domain       VARCHAR(255) DEFAULT NULL COMMENT 'Default verified domain — input for console deep-links (Management Consoles Launcher)',
  initial_domain       VARCHAR(255) DEFAULT NULL COMMENT 'Initial *.onmicrosoft.com domain — input for SharePoint admin slug',
  domain_resolved_at   DATETIME     DEFAULT NULL COMMENT 'When domains were last resolved via Graph /organization',
